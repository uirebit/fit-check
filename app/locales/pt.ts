const pt = {
    ...
    // FC Cloth Categories
    "fc_category.pants": "Calças",
    "fc_category.shirts": "Camisas",
    "fc_category.jackets": "Jaquetas",
    "fc_category.shoes": "Sapatos",
    "fc_category.gloves": "Luvas",
    "fc_category.helmets": "Capacetes",
    "fc_category.vests": "Coletes",
    "fc_category.headwear": "Chapelaria",
    "fc_category.footwear": "Calçados",
    "fc_category.clothing": "Vestuário",
    "fc_category.head_protection": "Proteção para Cabeça",
    "fc_category.hand_protection": "Proteção para Mãos",
    "fc_category.eye_face_protection": "Proteção Facial e Ocular",
    "fc_category.respiratory_protection": "Proteção Respiratória",
    "fc_category.high_visibility": "Alta Visibilidade",
    "fc_category.thermal_clothing": "Vestuário Térmico",
    "fc_category.welding": "Soldagem",
    "fc_category.lab_wear": "Vestuário de Laboratório",
  ...
  "admin.users.cannotEdit": "Não é possível editar superadmin",
    ...
    "admin.exportMeasurements": "Exportar Pedido de Roupas",
    "admin.exportingMeasurements": "Exportando...",
    "admin.exportSuccess": "Exportação bem-sucedida",
    "admin.exportSuccessDesc": "O pedido de roupas foi exportado para Excel",
    "admin.exportFailed": "Falha na exportação",
    
    // Excel export columns
    "excel.column.quantity": "Quantidade",
    "excel.column.clothingId": "ID da Roupa",
    "excel.column.clothingItem": "Item de Roupa",
    "excel.column.category": "Categoria",
    "excel.column.calculatedSize": "Tamanho Calculado",
    "excel.unknown": "Desconhecido",
    "excel.sheetName": "Pedido de Roupas",
    "excel.fileName": "pedido_roupas",
